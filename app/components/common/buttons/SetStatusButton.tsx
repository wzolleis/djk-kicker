...
const SetStatusButton = ({image, icon, onClick, isActive, activeColor}: SetStatusButtonProps) => {
    const buttonActive = classNames({[`${activeColor}`]: isActive}, {[`bg-gray-200`]: !isActive}, "scale-110");
    const variants = {
        initial: {
            rotate: 0,
            scale: 1,
